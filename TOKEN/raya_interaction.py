...
def speak(text, lang_code='hi'):
    ...
    try:
        ...
        # Raspberry Pi delay for SD card write
        time.sleep(0.4) 
...
def call_api_with_thinking_sound(payload):
    """API Call ke waqt background mein 'voice_inbetween.mpeg' chalega"""
    ...
    def play_loop():
        ...
        if os.path.exists(sound_file):
            try:
                ...
                channel = thinking_sound.play(loops=-1) # Loop indefinitely
...
def main():
    ...
    # 2. NAME (Thinking sound plays here)
    ...
    name_res = call_api_with_thinking_sound(payload_name)
    ...
    # 5. DYNAMIC QUESTIONS (Thinking sound plays here)
    ...
    # 6. FINAL REPORT (Thinking sound plays here)
    ...
    try: os.startfile(os.path.abspath(pdf_path))
    except: pass
